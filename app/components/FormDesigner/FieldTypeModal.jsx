          ...
          {activeTab === "custom" && (
            <s-stack direction="block" gap="base">
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <s-text variant="heading-sm">Custom Field: </s-text>
                  <s-text tone="subdued">Text, dropdown, checkbox, date, and more</s-text>
                </div>
                <div style={{ fontSize: "20px", color: "#6b7280" }}>›</div>
              </div>
              <div
                onClick={() => onSelectType("custom", null, "whatsapp")}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: "12px",
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <s-text variant="heading-sm">WhatsApp Button</s-text>
                </div>
                <div style={{ fontSize: "20px", color: "#6b7280" }}>›</div>
              </div>
            </s-stack>
